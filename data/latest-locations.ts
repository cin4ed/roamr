...
export const latestLocations: [Location] = [
  {
    ...
    rating: 4,
    images: [
      "https://www.diarioelindependiente.mx/uploads/2023/11/16998640951cc2a.jpg",
    ],
    addedBy: {
      name: "Damian",
      lastName: "Pérez",
  ...
  },
  {
    ...
    dateAdded: "2025-2-21",
    description:
      "An abandoned luxury hotel in Croatia, a relic of the Yugoslav era.",
    country: "Croacia",
    status: "verified",
    rating: 4,
    images: [
  ...
  },
  {
    ...
    dateAdded: "2025-2-21",
    description:
      "An iconic abandoned hotel in Texas, famous for its history and mineral springs.",
    country: "United States",
    status: "inReview",
    rating: 4,
    images: [
      "https://lh5.googleusercontent.com/p/AF1QipMXPxOMaO94JivMONhHJPAnRYP1t7AEk_eTOYyw",
    ],
    addedBy: {
      name: "Carlos",
      lastName: "Mendoza",
  ...
  },
  {
    ...
    rating: 4,
    images: [
      "https://lh5.googleusercontent.com/p/AF1QipPLDmWTsjGe_jNanl_PG2kFbc7uHxYXb6cM3W9R",
    ],
    addedBy: {
      name: "Carlos",
      lastName: "Rodarte",
