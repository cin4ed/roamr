  ...
  return (
    <div className="h-screen w-screen font-[family-name:var(--font-geist-sans)] flex">
      <div className="w-full h-full relative">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 flex gap-2 justify-center" style={{ paddingBottom: `max(20px, env(safe-area-inset-bottom, 24px))` }}>
          <Button
          ...
          <Button
            ...
            onClick={() => {
              if (selectedLocation) {
                ...
                router.push(`/create/details?lat=${selectedLocation.latitude}&lng=${selectedLocation.longitude}`);
              }
            }}
